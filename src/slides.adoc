...
//this shows how much UX heuristics (have default values) have much in common
//with programming
...
//TODO: API - Niesen Norman usability houristics
...
* icon:check-square-o[] {zwsp} {zwsp} Nielsen and Krug Heuristics _(from UX)_
