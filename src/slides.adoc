...
image::07-clean-code.jpg[background, size=contain]

== !

image::11a-implementation-patterns.jpg[background, size=contain]
...
* icon:square-o[] {zwsp} {zwsp} Nielsen and Krug Heuristics _(from UX)_
...
image::21-design-of-everyday-things.jpg[background, size=contain]
...
image::https://media.giphy.com/media/YttkaW0vdUCC4/giphy.gif[background, size=contain]

== Thank you!

image::https://media.giphy.com/media/mbpaehNenYdSE/giphy.gif[background, size=contain]
...
This presentation was made with Asciidoc & AsciiDoctor
